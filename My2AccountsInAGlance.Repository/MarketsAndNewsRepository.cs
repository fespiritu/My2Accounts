...
{
    public class MarketsAndNewsRepository : RepositoryBase<My2AccountsInAGlance>, IMarketsAndNewsRepository
    {
        ...
        private OperationStatus DeleteMarketIndexRecords(My2AccountsInAGlance context)
        {
            try
            {
