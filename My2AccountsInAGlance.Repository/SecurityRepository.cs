...
using My2AccountsInAGlance.Repository.Helpers;
using System;
...
{
    public class SecurityRepository : RepositoryBase<My2AccountsInAGlance>, ISecurityRepository
    {
        ...
        private static OperationStatus InsertSecurities(List<Security> securities, My2AccountsInAGlance context)
        {
            foreach (var security in securities)
            {
        ...
        private OperationStatus InsertExchanges(IEnumerable<string> exchanges, My2AccountsInAGlance context)
        {
            //Insert Exchanges
        ...
        private OperationStatus DeleteSecurityRecords(My2AccountsInAGlance context)
        {
